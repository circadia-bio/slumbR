...
Source:
[`DESCRIPTION`](https://github.com/circadia-bio/slumbR/blob/v0.1.0/DESCRIPTION)

França L, Leocadio-Miguel M (2026). *slumbR: Sleep Diaries Helper
Package for R*. R package version 0.1.0,
<https://github.com/circadia-bio/slumbR>.

    @Manual{,
      title = {slumbR: Sleep Diaries Helper Package for R},
      author = {Lucas França and Mario Leocadio-Miguel},
      year = {2026},
      note = {R package version 0.1.0},
      url = {https://github.com/circadia-bio/slumbR},
    }
